...
public class ProductRepositoryTests extends BaseJPATest{
	...
	@Test
	@DisplayName("Finding day product")
	public void testDayProduct() {
		...
		em.persist(q3);
		em.persist(q4);
		Optional<Product> actual = productRepository.findProductOfTheDay();
		Assertions.assertThat(actual).isNotEmpty();
		Assertions.assertThat(actual.get()).isEqualTo(p2);
	}
